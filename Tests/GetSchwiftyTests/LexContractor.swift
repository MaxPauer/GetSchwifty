...
final class LexContractorTests: XCTestCase {
    func testRanges() throws {
        ...
        testLex("A's b'ee\n's \"an\"' c ' '' ts", [
            ...
            (WhitespaceLex.self, " ", "␣",      (2,2), (2,3)),
            (StringLex.self, "an", "\"an\"",    (2,3), (2,7)),
            (WhitespaceLex.self, "'", "'",      (2,7), (2,8)),
            (WhitespaceLex.self, " ", "␣",      (2,8), (2,9)),
            (IdentifierLex.self, "c", "c",      (2,9), (2,10)),
            (WhitespaceLex.self, " ", "␣",      (2,10), (2,11)),
            (WhitespaceLex.self, "'", "'",      (2,11), (2,12)),
            (WhitespaceLex.self, " ", "␣",      (2,12), (2,13)),
            (WhitespaceLex.self, "'", "'",      (2,13), (2,14)),
            (WhitespaceLex.self, "'", "'",      (2,14), (2,15)),
            (WhitespaceLex.self, " ", "␣",      (2,15), (2,16)),
            (IdentifierLex.self, "ts", "ts",    (2,16), (2,18)),
            (NewlineLex.self,    "\u{03}", "␃", (2,18), (3,0)),
        ])
    }
}
